...
// app.get("/posts/:searchedTitle", (req, res)=>{
//   let searchedTitle = req.params.searchedTitle;

//   async function findPost(){
//     const post = await Post.findOne({name: searchedTitle});
//     try{
//       res.render("post", {postTitle: post.name,postContent: post.content});
//     }catch(err){
//       console.log(err);
//     }
//   }
...
app.get("/posts/:postID", (req, res)=>{
  ...
  Post.findById(postID).then(foundPost => {
    res.render("post", {postTitle: foundPost.name, postContent: foundPost.content})
  }).catch(err => {
    console.log(err);
  })
})
